...
<body>
	calculate form page '${calc["stringinvoer"]}'
	<hr>
	<br>
	<!--          
	...
	<form method="get" action="calculate">
		<table class="center">
			<tr>
				...
				<td><input name="username" value=nothing size="15"></td>
			</tr>
			<tr>
				<td align="right">passwordtest:</td>
				<td><input name="password" value=nothing size="15"></td>
			</tr>
			<tr>
